library(tidyverse)
data_file <- "/Users/ritalavi/Documents/GitHub/spanish_vowel_corpus/data/results.csv"
...
df %>%
  ...
  write_csv("/Users/ritalavi/Documents/GitHub/spanish_vowel_corpus/data/mislabled.csv")
